...
jQuery(document).on("ready", function () {
  ...
  function collapseMenu() {
    jQuery(
      ".wt-navigation ul li.menu-item-has-children, .wt-navdashboard ul li.menu-item-has-children, .wt-navigation ul li.menu-item-has-mega-menu"
    ).prepend(
      '<span class="wt-dropdowarrow"><i class="lnr lnr-chevron-left"></i></span>'
    );
    jQuery(
      ".wt-navigation ul li.menu-item-has-children span, .wt-navigation ul li.menu-item-has-mega-menu span"
    ).on("click", function () {
  ...
  _readmore.readmore({
    speed: 500,
    collapsedHeight: 230,
    moreLink: '<a class="wt-btntext" href="#">بیشتر بخوانید</a>',
    lessLink: '<a class="wt-btntext" href="#">کمتر</a>',
  });
  /*  PROGRESS BAR */
  try {
  ...
  jQuery(".wt-forgot-password").on("click", function (e) {
    ...
    jQuery(".wt-loginheader span").html("بازیابی رمز");
