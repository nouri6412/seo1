        ...
        <form class="wt-formtheme wt-userform wt-formprojectinfo">
            <fieldset>
                ...
                <input id="pro-imput-<?php echo $rand; ?>" value="" data-id="img" type="hidden">
                    ...
                    <input data-id="title" type="text" name="Project Title" class="form-control" placeholder="عنوان پروژه">
                </div>
                <div class="form-group form-group-half">
                    <input data-id="address" type="text" name="Project URL" class="form-control" placeholder="آدرس پروژه">
                </div>
                <div class="form-group">
                    <textarea data-id="desc" name="message" class="form-control" placeholder="شرح پروژه"></textarea>
                </div>
