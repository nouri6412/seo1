        ...
        <form class="wt-formtheme wt-userform">
            <fieldset>
                <div class="form-group form-group-half">
                    <input data-id="company_title" type="text" name="Company Title" class="form-control" placeholder="عنوان شرکت">
                </div>
                <div class="form-group form-group-half">
                ...
                <div class="form-group form-group-half">
                    <input data-id="job_title" type="text" name="Job Title" class="form-control" placeholder="عنوان شغل شما">
                </div>
                <div class="form-group">
                    <textarea data-id="job_desc" name="message" class="form-control" placeholder="شرح شغل شما"></textarea>
                </div>
                <div class="form-group">
